                    ...
                    foreach ($client_service as $client) {
                        ...
                        if($new_date_start > $client->date_start && $new_date_start < $client->date_end)
                        {
                            ...
                            if($client_master->id == 46){
                                return response()->json(['response' => 1, $new_date_end, $client->date_start, $client->date_end], 400);
                            }
                        ...
                        if($client->date_start > $new_date_start && $client->date_start < $new_date_end)
                        {
                            $pass++;
                            if($client_master->id == 46){
                                return response()->json(['response' => 3, $new_date_end, $client->date_start, $client->date_end], 400);
                            }
                        ...
                        if($client->date_end > $new_date_start && $client->date_end < $new_date_end)
                        {
                            $pass++;
                            if($client_master->id == 46){
                                return response()->json(['response' => 4, $new_date_end, $client->date_start, $client->date_end], 400);
                            }
